...
export default function ChallengePhotosPage() {
    ...
    if (!challenge) return <div className="p-12">Challenge not found</div>;
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-foreground/50">{challengePhotos.length} photos</p>
                        </div>
                    </div>
                ...
                <div className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
                    {challengePhotos.length === 0 ? (
                        <div className="col-span-full py-12 text-center text-foreground/40 text-lg">
                            No photos for this challenge yet.
                        </div>
                    ) : (
